...
void Scene::TrainEntity (b2World* m_physicsWorld, std::string fileName, int width, int height, float transparency, vec3 position, float shrinkX, float shrinkY, float tempDefPositionX, float tempDefPositionY) {
	auto entity = ECS::CreateEntity();
	//Add components
	ECS::AttachComponent<Sprite>(entity);
	ECS::AttachComponent<Transform>(entity);
...
void Scene::CoinTrigger(b2World* m_physicsWorld, std::string fileName, int width, int height, float transparency, vec3 position, float shrinkX, float shrinkY, float tempDefPositionX, float tempDefPositionY)
{
	//Setup trigger
	{
		//Creates entity
		...
		ECS::GetComponent<Trigger*>(entity)->SetTriggerEntity(entity);
		ECS::GetComponent<Trigger*>(entity)->AddTargetEntity(coin);
...
void Scene::JumpBootTrigger(b2World* m_physicsWorld, std::string fileName, int width, int height, float transparency, vec3 position, float shrinkX, float shrinkY, float tempDefPositionX, float tempDefPositionY)
{
	//Setup trigger
	{
		//Creates entity
		...
		ECS::GetComponent<Sprite>(entity).SetTransparency(transparency);
		ECS::GetComponent<Transform>(entity).SetPosition(position);
		ECS::GetComponent<Trigger*>(entity) = new JumpBootThing();

		ECS::GetComponent<Trigger*>(entity)->SetTriggerEntity(entity);
		ECS::GetComponent<Trigger*>(entity)->AddTargetEntity(jumpboot);
...
void Scene::StarTrigger(b2World* m_physicsWorld, std::string fileName, int width, int height, float transparency, vec3 position, float shrinkX, float shrinkY, float tempDefPositionX, float tempDefPositionY)
{
	//Setup trigger
	{
		//Creates entity
		...
		ECS::GetComponent<Sprite>(entity).SetTransparency(transparency);
		ECS::GetComponent<Transform>(entity).SetPosition(position);
		ECS::GetComponent<Trigger*>(entity) = new StarThing();

		ECS::GetComponent<Trigger*>(entity)->SetTriggerEntity(entity);
		ECS::GetComponent<Trigger*>(entity)->AddTargetEntity(star);
...
void Scene::HurdleTrigger(b2World* m_physicsWorld, std::string fileName, int width, int height, float transparency, vec3 position, float shrinkX, float shrinkY, float tempDefPositionX, float tempDefPositionY)
{
	//Setup trigger
	{
		//Creates entity
		...
		ECS::GetComponent<Sprite>(entity).SetTransparency(transparency);
		ECS::GetComponent<Transform>(entity).SetPosition(position);
		ECS::GetComponent<Trigger*>(entity) = new HurdleThing();

		ECS::GetComponent<Trigger*>(entity)->SetTriggerEntity(entity);
		ECS::GetComponent<Trigger*>(entity)->AddTargetEntity(hurdle);
