...
public:
	...
	void CreateMoveableEntity(b2World* m_physicsWorld, std::string fileName, int width, int height, float transparency, vec3 position, float shrinkX, float shrinkY, float tempDefPositionX, float tempDefPositionY);
	void CreateEnemy(int entity, b2World* m_physicsWorld, std::string fileName, int width, int height, vec3 position, float shrinkX, float shrinkY, float tempDefPositionX, float tempDefPositionY);
